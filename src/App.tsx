...
const TEAM_MEMBERS = [
  ...
  },
  {
    ...
    role: 'Ac Master',
    seed: 13,
    image: 'https://media.discordapp.net/attachments/1410648492770066452/1516984801125470348/vztjtq7.png?ex=6a34a1b0&is=6a335030&hm=03d3782305a0bed3a23002dd45a2ba50af2dc5679de493980a915f8546c53783&=&format=webp&quality=lossless',
  },
  {
    name: 'Atizade',
    role: 'Ac Team',
    seed: 23,
    image: 'https://media.discordapp.net/attachments/1410648492770066452/1516984870058856559/102e63ad22e7ec9f389514b2e6561001.jpg?ex=6a34a1c1&is=6a335041&hm=217195f5ab4a68073a1ab9967f3d8e5407d4fc0f3a965c2bacecd75c6212dcdf&=&format=webp',
  },
  {
    name: 'Sdark',
    role: 'Ac Team',
      ...
      >
        ...
        <div className="bg-black/60 backdrop-blur-sm">
          ...
          <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
            {/* Subtle node pattern behind image */}
              ...
              <div className="relative w-full h-full">
                <img
                  ...
                  className={`
                    ...
                    ${hovered ? 'scale-105 brightness-[0.85] contrast-125' : 'brightness-[0.55] contrast-110 grayscale-[20%]'}
                  `}
                />
                ...
                <div
                  className={`
                    absolute inset-0 bg-cyan-500/[0.08] transition-opacity duration-500
...
function MagneticButton() {
  ...
  return (
    <motion.button
      ...
      onClick={() => window.open('https://anticheat.ac', '_blank')}
      animate={{
        x: position.x,
        y: position.y,
      }}
